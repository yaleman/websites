# websites
A client library for accessing websites

## Usage
First, create a client:

```python
from websites import Client
...
```python
from websites import AuthenticatedClient
...
```python
from websites.models import MyDataModel
from websites.api.my_tag import get_my_data_model
from websites.types import Response
...
1. Any endpoint which did not have a tag will be in `websites.api.default`
