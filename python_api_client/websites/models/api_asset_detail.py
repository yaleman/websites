...
if TYPE_CHECKING:
    from ..models.api_asset_variant import ApiAssetVariant


T = TypeVar("T", bound="ApiAssetDetail")
...
class ApiAssetDetail:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for variants_item_data in _variants:
            variants_item = ApiAssetVariant.from_dict(variants_item_data)
